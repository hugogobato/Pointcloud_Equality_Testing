...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| HybridBlockMMD-a0.50 | H0^law: P0 = P1 (raw characteristic fixed-size block representation, m=25, under iid point sampling) | frozen disjoint m-point block | 25 | 10.0 | 10.0 | 0.046 | 0.996 | 1.000 | 0.504 | n/a | 0.052 | 162662087
| RawBlockMMD | H0^law: P0 = P1 (raw characteristic fixed-size block representation, m=25, under iid point sampling) | frozen disjoint m-point block | 25 | 10.0 | 10.0 | 0.064 | 0.998 | 1.000 | 1.000 | n/a | 0.013 | 162651542
| SC-A-Block | H0^law: P0 = P1 (raw characteristic fixed-size block representation, m=25, under iid point sampling) | frozen disjoint m-point block | 25 | 10.0 | 10.0 | 0.060 | 0.996 | 1.000 | 1.000 | n/a | 0.013 | 162665495
| SC-B | H0,25^bar: Phi^25_0:1(P0) = Phi^25_0:1(P1) | disjoint m-point block | 25 | 10.0 | 10.0 | 0.042 | 0.988 | 0.998 | 0.054 | n/a | 0.045 | 162651542
